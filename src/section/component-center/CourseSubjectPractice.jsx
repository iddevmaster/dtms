...
export default class CourseSubjectPractice extends Component {
  ...
  state = {
    ...
    course_practice_hour: this.props.course_practice_hour,
  ...
  render() {
    ...
    const { course_practice_hour } = this.props;
          ...
          <Card.Body>
            ...
            <div align="center">
              <h4>
                ...
                <span style={{ color: "blue" }}> {course_practice_hour}</span>
              </h4>
            </div>
          </Card.Body>
        </Card>
